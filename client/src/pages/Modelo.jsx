    ...
    <div className='mt-10 items-center justify-center flex flex-col h-full'>
      ...
      <div className='text-small md:text-xl mt-6 mr-4 ml-4 md:mr-6 md:ml-6 mb-10 text-center'>
        <p className='text-slate-900'><i>Esta experiencia pedagógica busca lograr un equilibrio saludable
          entre la formación académica y deportiva, permitiendo que los estudiantes se desarrollen de manera
          integral y alcancen su máximo potencial en ambas áreas. La institución permitirá que los estudiantes
