    ...
    <div className='mt-10 items-center justify-center flex flex-col h-full'>
      ...
      <div className='text-small md:text-2xl mt-6 mr-4 ml-4 md:mr-6 md:ml-6'>
        <p className='text-slate-900 text-center mb-3'><i>Promover un ambiente de aprendizaje integral que fomente el desarrollo
          académico y deportivo de nuestros estudiantes, cultivando en ellos valores, habilidades y competencias que les permitan
          sobresalir en ambas áreas, y contribuir activamente a la comunidad.</i></p>
        <p className='text-slate-900 text-center'><i>Este objetivo se enfoca en el equilibrio entre la formación académica y
      ...
      <div className='text-small md:text-2xl mt-6 mr-4 ml-4 md:mr-6 md:ml-6'>
        <p className='text-slate-900 text-center'><i>Comienza por pedir a cada estudiante que establezca metas tanto académicas
      ...
      <div className='flex flex-col items-center justify-center w-full'>
        <h2 className='text-xl md:text-4xl flex-col mb-6 md:mb-10 text-center'><b><i>Planificación del Tiempo</i></b></h2>
      </div>
      <div className='text-small md:text-2xl mt-6 mr-4 ml-4 md:mr-6 md:ml-6'>
        <p className='text-slate-900 text-center'><i>Ayuda a los estudiantes a crear horarios de estudio y entrenamiento que se
